...
const PORTFOLIO_ITEMS = [
  {
    ...
    title: 'Stara Vura — Visual Identity',
  },
  {
    category: 'MENU DESIGN',
    title: 'Konoba Adriatic — Seasonal Menu',
  },
  {
    category: 'SOCIAL MEDIA',
    title: 'La Piazza — Instagram Campaign',
  },
  {
    category: 'VIDEO PRODUCTION',
    title: 'Restoran Mala Barka — Launch Reel',
  },
  {
    category: 'BRAND STRATEGY',
    title: 'Kafić Stari Grad — Rebranding',
  },
  {
    category: 'PRINT & PACKAGING',
    title: 'Bakery Zrno — Packaging Design',
  },
];
    ...
    >
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <ScrollReveal delay={0.1}>
          ...
          >
            Selected{' '}
            <span style={{ color: '#D4A574', fontStyle: 'italic' }}>work.</span>
          </h2>
        </ScrollReveal>
