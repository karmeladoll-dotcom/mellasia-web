  ...
  return (
    <div className="relative w-full">
      <style>{`
        ...
        @media (hover: hover) {
          .letterhead-hover-zone:hover .letterhead-aurora-breath {
            animation: none;
            opacity: 1;
            transform: translate(-50%, -50%) scale(1.15);
          }
          .letterhead-hover-zone:hover .letterhead-card {
      ...
      <div
        className="letterhead-card relative z-10 rounded-xl text-center"
        style={{
  ...
  return (
    ...
    >
      <div className="mx-auto flex max-w-6xl flex-col gap-12 md:flex-row md:gap-12">
        ...
        <ScrollReveal
          delay={0.2}
          className="letterhead-hover-zone mt-12 w-full md:mt-0 md:w-[42%] md:self-center"
        >
          <LetterheadCard />
        </ScrollReveal>
      </div>
